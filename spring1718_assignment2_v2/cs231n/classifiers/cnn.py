...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        # 2*2 pooling,H and W all should be divided by 2
    ...
    def loss(self, X, y=None):
        ...
        # affine - relu
        aff_out1, aff_cache1 = affine_relu_forward(conv_out, W2, b2)
        # affine 
        aff_out2, aff_cache2 = affine_forward(aff_out1, W3, b3)
        scores = aff_out2
        ...
        da2, dw3, db3 = affine_backward(dx, aff_cache2)
        da1, dw2, db2 = affine_relu_backward(da2, aff_cache1)
